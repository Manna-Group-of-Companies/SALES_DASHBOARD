...
async function listSalesCustomers(reps?: string[]): Promise<SalesCustomer[]> {
  ...
  return rows.map((r) => ({
    ...
    outstanding0_30: Number(r[SALES_CUSTOMER_FIELD.outstanding0_30]) || 0,
    outstanding30_60: Number(r[SALES_CUSTOMER_FIELD.outstanding30_60]) || 0,
    outstanding60_90: Number(r[SALES_CUSTOMER_FIELD.outstanding60_90]) || 0,
    outstanding90Plus: Number(r[SALES_CUSTOMER_FIELD.outstanding90Plus]) || 0,
